...
# Valerio: this experimental feature should be ON on macOS
option(LUAJIT_ENABLE_GC64 "Enable GC64" OFF)
MARK_AS_ADVANCED(LUAJIT_DISABLE_FFI LUAJIT_ENABLE_LUA52COMPAT LUAJIT_DISABLE_JIT LUAJIT_CPU_SSE2 LUAJIT_CPU_NOCMOV LUAJIT_ENABLE_GC64)
...
ELSEIF(WITH_OBJECT_LUA)
  IF(WITH_AMALG)
    add_library(luajit-5.1 OBJECT ${LUAJIT_DIR}/src/ljamalg.c ${DEPS} )
  ELSE()
    add_library(luajit-5.1 OBJECT ${SRC_LJCORE} ${DEPS} )
  ENDIF()
...
# Valerio: if it's macOS we need to set the pagezero and image_base
IF(APPLE)
  target_link_libraries (luajit-5.1 ${LIBS} "-pagezero_size 10000 -image_base 100000000")
ELSE()
...
ELSE()
  ...
  # Valerio: if it's macOS we need to set the pagezero and image_base
  IF(APPLE)
    target_link_libraries(luajit ${LIBS} "-pagezero_size 10000 -image_base 100000000")
  ELSE()
