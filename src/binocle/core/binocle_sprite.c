...
void binocle_sprite_draw(binocle_sprite sprite, binocle_gd *gd, int64_t x, int64_t y, kmAABB2 viewport, float rotation, float scale) {
  ...
  // TL
  vertices[0].pos.x = -sprite.origin.x * cosf(rotation) - (-sprite.origin.y + sprite.material->texture->height) * sinf(rotation) + x;
  vertices[0].pos.y = (-sprite.origin.y + sprite.material->texture->height) * cosf(rotation) - sprite.origin.x * sinf(rotation) + y;
  ...
  // TR
  vertices[1].pos.x = (-sprite.origin.x + sprite.material->texture->width) * cosf(rotation) - (-sprite.origin.y + sprite.material->texture->height) * sinf(rotation) + x;
  vertices[1].pos.y = (-sprite.origin.y + sprite.material->texture->height) * cosf(rotation) + (-sprite.origin.x + sprite.material->texture->width) * sinf(rotation) + y;
  ...
  // BL
  vertices[2].pos.x = -sprite.origin.x * cosf(rotation) + sprite.origin.y * sinf(rotation) + x;
  vertices[2].pos.y = -sprite.origin.y * cosf(rotation) - sprite.origin.x * sinf(rotation) + y;
  ...
  // TR
  vertices[3].pos.x = (-sprite.origin.x + sprite.material->texture->width) * cosf(rotation) - (-sprite.origin.y + sprite.material->texture->height) * sinf(rotation) + x;
  vertices[3].pos.y = (-sprite.origin.y + sprite.material->texture->height) * cosf(rotation) + (-sprite.origin.x + sprite.material->texture->width) * sinf(rotation) + y;
  ...
  // BR
  vertices[4].pos.x = (-sprite.origin.x + sprite.material->texture->width) * cosf(rotation) + sprite.origin.y * sinf(rotation) + x;
  vertices[4].pos.y = -sprite.origin.y * cosf(rotation) + (-sprite.origin.x + sprite.material->texture->width) * sinf(rotation) + y;
  ...
  // BL
  vertices[5].pos.x = -sprite.origin.x * cosf(rotation) + sprite.origin.y * sinf(rotation) + x;
  vertices[5].pos.y = -sprite.origin.y * cosf(rotation) - sprite.origin.x * sinf(rotation) + y;
