...
if (DEBUG)
    ...
    set (CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g -s ASSERTIONS=2 -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='[\"png\"]' -s USE_ZLIB=1 -s USE_LIBPNG=1 -s USE_VORBIS=1 -s USE_OGG=1 -s STB_IMAGE=1 -s INITIAL_MEMORY=1073741824 -s DISABLE_EXCEPTION_CATCHING=0 -s NO_EXIT_RUNTIME=1 -s USE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 --preload-file ${BINOCLE_DATA_DIR}@/assets/ --shell-file ${BINOCLE_DATA_DIR}index.html --use-preload-plugins -Wno-invalid-offsetof -std=gnu++0x")
    set (CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -g -s ASSERTIONS=2 -s USE_SDL=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='[\"png\"]' -s USE_ZLIB=1 -s USE_LIBPNG=1 -s USE_VORBIS=1 -s USE_OGG=1 -s STB_IMAGE=1 -s INITIAL_MEMORY=1073741824 -s DISABLE_EXCEPTION_CATCHING=0 -s NO_EXIT_RUNTIME=1 -s USE_WEBGL2=1 -sMIN_WEBGL_VERSION=2 -sMAX_WEBGL_VERSION=2 --preload-file ${BINOCLE_DATA_DIR}@/assets/ --shell-file ${BINOCLE_DATA_DIR}index.html --use-preload-plugins")
else()
